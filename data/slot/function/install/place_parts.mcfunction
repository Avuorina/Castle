...
## ステージ
    summon item_display ^0 ^2 ^-0.99 {Tags:["Stage"],item:{id:"minecraft:iron_ingot",count:1,components:{"minecraft:custom_model_data":{strings:["normal1"]}}},item_display:"fixed"} 
