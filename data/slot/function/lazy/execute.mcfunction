...
## レバー
    execute if score @s SlotState matches 0 if score @s LazyState matches 0 run function slot:lever/pull

## ボタン
    execute if score @s SlotState matches 3 if score @s LazyState matches 1 run function slot:button/push/left/update
    ...
    execute if score @s SlotState matches 3 if score @s LazyState matches 2 run function slot:button/push/center/update
    ...
    execute if score @s SlotState matches 3 if score @s LazyState matches 3 run function slot:button/push/right/update
    ...
    execute if score @s SlotState matches 3 run function slot:button/place
