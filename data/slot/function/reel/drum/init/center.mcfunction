...
## 面0（strip index 0 = シンボル1）
    ...
    execute as @e[type=item_display,tag=face_index_C_0] run scoreboard players set @s ReelDrumFaceIndex 0
...
## 面1（strip index 1 = シンボル7）
    ...
    execute as @e[type=item_display,tag=face_index_C_1] run scoreboard players set @s ReelDrumFaceIndex 1
...
## 面2（strip index 2 = シンボル3）
    ...
    execute as @e[type=item_display,tag=face_index_C_2] run scoreboard players set @s ReelDrumFaceIndex 2
...
## 面3（strip index 3 = シンボル4）
    ...
    execute as @e[type=item_display,tag=face_index_C_3] run scoreboard players set @s ReelDrumFaceIndex 3
...
## 面4（strip index 4 = シンボル2）
    ...
    execute as @e[type=item_display,tag=face_index_C_4] run scoreboard players set @s ReelDrumFaceIndex 4
...
## 面5（strip index 5 = シンボル8）
    ...
    execute as @e[type=item_display,tag=face_index_C_5] run scoreboard players set @s ReelDrumFaceIndex 5
...
## 面6（strip index 6 = シンボル7）
    ...
    execute as @e[type=item_display,tag=face_index_C_6] run scoreboard players set @s ReelDrumFaceIndex 6
...
## 面7（strip index 7 = シンボル3）
    ...
    execute as @e[type=item_display,tag=face_index_C_7] run scoreboard players set @s ReelDrumFaceIndex 7
...
## 面8（strip index 8 = シンボル4）
    ...
    execute as @e[type=item_display,tag=face_index_C_8] run scoreboard players set @s ReelDrumFaceIndex 8
...
## 面9（strip index 9 = シンボル2）
    ...
    execute as @e[type=item_display,tag=face_index_C_9] run scoreboard players set @s ReelDrumFaceIndex 9
...
## 面10（strip index 10 = シンボル6）
    ...
    execute as @e[type=item_display,tag=face_index_C_10] run scoreboard players set @s ReelDrumFaceIndex 10
...
## 面11（strip index 11 = シンボル7）
    ...
    execute as @e[type=item_display,tag=face_index_C_11] run scoreboard players set @s ReelDrumFaceIndex 11
...
## 面12（strip index 12 = シンボル3）
    ...
    execute as @e[type=item_display,tag=face_index_C_12] run scoreboard players set @s ReelDrumFaceIndex 12
...
## 面13（strip index 13 = シンボル4）
    ...
    execute as @e[type=item_display,tag=face_index_C_13] run scoreboard players set @s ReelDrumFaceIndex 13
...
## 面14（strip index 14 = シンボル8）
    ...
    execute as @e[type=item_display,tag=face_index_C_14] run scoreboard players set @s ReelDrumFaceIndex 14
...
## 面15（strip index 15 = シンボル5）
    ...
    execute as @e[type=item_display,tag=face_index_C_15] run scoreboard players set @s ReelDrumFaceIndex 15
...
## 面16（strip index 16 = シンボル7）
    ...
    execute as @e[type=item_display,tag=face_index_C_16] run scoreboard players set @s ReelDrumFaceIndex 16
...
## 面17（strip index 17 = シンボル3）
    ...
    execute as @e[type=item_display,tag=face_index_C_17] run scoreboard players set @s ReelDrumFaceIndex 17
...
## 面18（strip index 18 = シンボル4）
    ...
    execute as @e[type=item_display,tag=face_index_C_18] run scoreboard players set @s ReelDrumFaceIndex 18
...
## 面19（strip index 19 = シンボル2）
    ...
    execute as @e[type=item_display,tag=face_index_C_19] run scoreboard players set @s ReelDrumFaceIndex 19
