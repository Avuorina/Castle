...
# シングル(リプレイ) 2366/8192
    # [デバッグ用]
        execute if score @s _ matches 1..2366 run tellraw @a[team=Debug] {"text":"シングルーン(リプレイ)",color:"green"}
...
# シングル(payout 2) 3549 /8192
    # [デバッグ用]
        execute if score @s _ matches 2367..5915 run tellraw @a[team=Debug] {"text":"シングルーン(２枚払い出し)",color:"green"}
    execute if score @s _ matches 2367..5915 run function slot:reel/result/symbol/rune/pattern/single_pay2/

# ダブル 1498/8192
    # [デバッグ用]
        execute if score @s _ matches 5916..7413 run tellraw @a[team=Debug] {"text":"ダブルーン",color:"green"}
...
# チェリー 374/8192
    # [デバッグ用]
        execute if score @s _ matches 7414..7787 run tellraw @a[team=Debug] {"text":"チェリールーン",color:"green"}
    execute if score @s _ matches 7414..7787 run function slot:reel/result/symbol/rune/pattern/cherry/

# V 374/8192
    # [デバッグ用]
        execute if score @s _ matches 7788..8161 run tellraw @a[team=Debug] {"text":"Vルーン",color:"green"}
    execute if score @s _ matches 7788..8161 run function slot:reel/result/symbol/rune/pattern/v/

# トリプル 31/8192
    # [デバッグ用]
        execute if score @s _ matches 8162..8192 run tellraw @a[team=Debug] {"text":"トリプルーン",color:"green"}
