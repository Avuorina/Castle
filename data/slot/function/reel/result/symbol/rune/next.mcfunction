...
# 振り分け用
    ...
    execute if score @s ResultID matches 6..7 if score @s _ matches 1..70 run scoreboard players add @s PointIn 10
    execute if score @s ResultID matches 6..7 if score @s _ matches 71..97 run scoreboard players add @s PointIn 20
    execute if score @s ResultID matches 6..7 if score @s _ matches 98..100 run scoreboard players add @s PointIn 30
    execute if score @s ResultID matches 8..10 if score @s _ matches 1..72 run scoreboard players add @s PointIn 30
    execute if score @s ResultID matches 8..10 if score @s _ matches 73..99 run scoreboard players add @s PointIn 50
